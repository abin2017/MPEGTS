...
namespace Tests
{
    ...
    public class Tests
    {
        ...
        public void TestEIT()
        {
            ...
            Assert.AreEqual("Krimi zpr·vy", eventsDict[175].EventName);
            Assert.AreEqual("Aktu·lnÌ ud·losti z oblasti kriminality. ZloËiny oËima profesion·l˘, zkuöen˝ch reportÈr˘ i div·k˘. (PremiÈra)", eventsDict[175].Text);
            ...
            Assert.AreEqual("Epizoda: Sam· p¯ekvapenÌ Sid ¯eöÌ situaci s novou ûirafou. Viky a Filip ËelÌ d˘sledk˘m sv˝ch neËekan˝ch z·vazk˘. Raul pot¯ebuje pomoc s vedenÌm firmy. Krist˝na vezme Alberta na milost. Charlie se spojuje s B¯Èùou proti OvËÌkovi. HrajÌ M. Pech·Ëkov·, E. Bureöov·, T. Klus, B. Such·nkov·, D. Gr·nsk˝, M. NÏmec, B. »ern·, L. »ern·, J. ävandov·, V. Kratina a dalöÌ. Reûie L. Kodad. (PremiÈra)", eventsDict[177].Text);
            ...
            Assert.AreEqual("V z·bavnÈ show Inkognito se Ëtve¯ice osobnostÌ snaûÌ uhodnout profesi jednotliv˝ch host˘ nebo jejich identitu. H·dejte spoleËnÏ s nimi a pobavte se neËekan˝mi myölenkami. Moderuje Libor BouËek. (PremiÈra)", eventsDict[178].Text);
